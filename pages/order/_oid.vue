          ...
          <td colspan="3" class="Title red f18 fb"><p>限时折扣</p></td>
                    ...
                    <tr class="good">
                        <td class="name First">
                            ...
                            <div class="goodInfo">
                                <input type="hidden" class="ids ids_14502" value="14502"> <a target="_blank"
                                    :href="'https://localhost:3000/course/' + order.courseId">{{ order.courseTitle
                                    }}</a>
                            </div>
                        </td>
                        <td class="price">
            ...
            <div class="Finish">
                ...
                <div class="Main fl">
                    ...
                    <div class="fr">
                        <p>共 <strong class="red">1</strong> 件商品，合计<span class="red f20">￥<strong id="AllPrice">{{
                                order.totalFee
                        }}</strong></span></p>
                    </div>
                </div>
...
<script>
import orderApi from '../../api/index/orders'
export default {
    data() {
        return {
